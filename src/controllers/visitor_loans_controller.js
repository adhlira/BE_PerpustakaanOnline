import visitor_loans_service from "../services/visitor_loans_service.js";

const LoanController = new visitor_loans_service();

class visitor_loan_controller {
...
export default visitor_loan_controller;
